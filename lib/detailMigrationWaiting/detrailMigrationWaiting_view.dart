...
class DetailMigrationWaitingView extends StatelessWidget {
  DetailMigrationWaitingView(
      String _documentID, String? _name, String? _groupName, String? _age) {
                    ...
                    children: <Widget>[
                      ...
                      StreamBuilder<DocumentSnapshot>(
                          ...
                          builder: (BuildContext context,
                            ...
                            final DocumentSnapshot? migrationSnapshot =
                                snapshot.data;
                            if (snapshot.hasData) {
                              final String? phase =
                                  migrationSnapshot!.get('phase');
                              if (phase == 'wait') {
                                return Padding(
                                    padding: const EdgeInsets.all(10),
                                    child: Column(children: <Widget>[
                                      ...
                                      Consumer<DetailMigrationWaitingModel>(
                                          builder: (BuildContext context,
                                              DetailMigrationWaitingModel model,
                                              Widget? child) {
                                        if (model.isLoading) {
