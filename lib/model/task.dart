...
class Task {
  ...
  List<Map<String, dynamic>> syokyu = [
    {'number': '1', 'title': '基本', 'hasItem': 6},
    {'number': '2', 'title': '健康と発達', 'hasItem': 1},
    {'number': '3', 'title': 'スカウト技能', 'hasItem': 3},
    {'number': '4', 'title': '善行', 'hasItem': 1},
    {'number': '5', 'title': '信仰奨励', 'hasItem': 1},
    {'number': '6', 'title': '班長会議', 'hasItem': 1},
  ];

  List<Map<String, dynamic>> nikyu = [
    {'number': '1', 'title': '基本', 'hasItem': 3},
    {'number': '2', 'title': '健康と発達', 'hasItem': 4},
    {'number': '3', 'title': 'スカウト技能', 'hasItem': 17},
  ...
  List<Map<String, dynamic>> ikkyu = [
    ...
    {'number': '2', 'title': '健康と発達', 'hasItem': 4},
    {'number': '3', 'title': 'スカウト技能', 'hasItem': 20},
  ...
  List<Map<String, dynamic>> hayabusa = [
    ...
    {'number': '2', 'title': 'スカウト技能', 'hasItem': 4},
  ...
  List<Map<String, dynamic>> gino = [
    {'number': '01', 'title': '野営章', 'hasItem': 8, 'examination': false},
    {'number': '02', 'title': '野営管理章', 'hasItem': 7, 'examination': true},
    {'number': '03', 'title': '救急章', 'hasItem': 3, 'examination': true},
    {'number': '04', 'title': '野外炊事章', 'hasItem': 7, 'examination': false},
    {'number': '05', 'title': '公民章', 'hasItem': 8, 'examination': false},
    {'number': '06', 'title': 'パイオニアリング章', 'hasItem': 7, 'examination': true},
    {'number': '07', 'title': 'リーダーシップ章', 'hasItem': 5, 'examination': true},
    {'number': '08', 'title': 'ハイキング章', 'hasItem': 8, 'examination': true},
    {'number': '09', 'title': 'スカウトソング章', 'hasItem': 4, 'examination': true},
    {'number': '10', 'title': '通信章', 'hasItem': 5, 'examination': false},
    {'number': '11', 'title': '計測章', 'hasItem': 8, 'examination': false},
    {'number': '12', 'title': '観察章', 'hasItem': 6, 'examination': false},
    {'number': '13', 'title': '水泳章', 'hasItem': 9, 'examination': true},
    {'number': '14', 'title': '案内章', 'hasItem': 5, 'examination': true},
    {'number': '15', 'title': 'エネルギー章', 'hasItem': 8, 'examination': true},
    {'number': '16', 'title': '介護章', 'hasItem': 5, 'examination': true},
    {'number': '17', 'title': '看護章', 'hasItem': 4, 'examination': true},
    {'number': '18', 'title': '手話章', 'hasItem': 6, 'examination': true},
    {'number': '19', 'title': '世界友情章', 'hasItem': 7, 'examination': true},
    {'number': '20', 'title': '通訳章', 'hasItem': 4, 'examination': true},
    {'number': '21', 'title': '点字章', 'hasItem': 4, 'examination': true},
    {'number': '22', 'title': '園芸章', 'hasItem': 8, 'examination': true},
    {'number': '23', 'title': '演劇章', 'hasItem': 5, 'examination': true},
    {'number': '24', 'title': '音楽章', 'hasItem': 7, 'examination': true},
    {'number': '25', 'title': '絵画章', 'hasItem': 3, 'examination': true},
    {'number': '26', 'title': '華道章', 'hasItem': 6, 'examination': true},
    {'number': '27', 'title': '茶道章', 'hasItem': 5, 'examination': true},
    {'number': '28', 'title': '写真章', 'hasItem': 5, 'examination': true},
    {'number': '29', 'title': '書道章', 'hasItem': 7, 'examination': true},
    {'number': '30', 'title': '竹細工章', 'hasItem': 3, 'examination': true},
    {'number': '31', 'title': '伝統芸能章', 'hasItem': 2, 'examination': true},
    {'number': '32', 'title': '文化財保護章', 'hasItem': 4, 'examination': true},
    {'number': '33', 'title': '木工章', 'hasItem': 4, 'examination': true},
    {'number': '34', 'title': '安全章', 'hasItem': 9, 'examination': true},
    {'number': '35', 'title': '沿岸視察章', 'hasItem': 6, 'examination': true},
    {'number': '36', 'title': '家庭修理章', 'hasItem': 7, 'examination': true},
    {'number': '37', 'title': '環境衛生章', 'hasItem': 7, 'examination': true},
    {'number': '38', 'title': 'コンピューター章', 'hasItem': 7, 'examination': true},
    {'number': '39', 'title': '裁縫章', 'hasItem': 5, 'examination': true},
    {'number': '40', 'title': '搾乳章', 'hasItem': 7, 'examination': true},
    {'number': '41', 'title': '自動車章', 'hasItem': 3, 'examination': true},
    {'number': '42', 'title': '事務章', 'hasItem': 6, 'examination': true},
    {'number': '43', 'title': '珠算章', 'hasItem': 2, 'examination': true},
    {'number': '44', 'title': '消防章', 'hasItem': 10, 'examination': true},
    {'number': '45', 'title': '信号章', 'hasItem': 5, 'examination': true},
    {'number': '46', 'title': '森林愛護章', 'hasItem': 9, 'examination': true},
    {'number': '47', 'title': '洗濯章', 'hasItem': 7, 'examination': true},
    {'number': '48', 'title': '測量章', 'hasItem': 7, 'examination': true},
    {'number': '49', 'title': '測候章', 'hasItem': 8, 'examination': true},
    {'number': '50', 'title': '鳥類保護章', 'hasItem': 4, 'examination': true},
    {'number': '51', 'title': '釣り章', 'hasItem': 6, 'examination': true},
    {'number': '52', 'title': '溺者救助章', 'hasItem': 5, 'examination': true},
    {'number': '53', 'title': '電気章', 'hasItem': 6, 'examination': true},
    {'number': '54', 'title': '天文章', 'hasItem': 7, 'examination': true},
    {'number': '55', 'title': '土壌章', 'hasItem': 7, 'examination': true},
    {'number': '56', 'title': '農機具章', 'hasItem': 5, 'examination': true},
    {'number': '57', 'title': '農業経営章', 'hasItem': 5, 'examination': true},
    {'number': '58', 'title': '簿記章', 'hasItem': 2, 'examination': true},
    {'number': '59', 'title': '無線通信章', 'hasItem': 3, 'examination': true},
    {'number': '60', 'title': '有線通信章', 'hasItem': 4, 'examination': true},
    {'number': '61', 'title': '養鶏章', 'hasItem': 9, 'examination': true},
    {'number': '62', 'title': '養豚章', 'hasItem': 7, 'examination': true},
    {'number': '63', 'title': 'ラジオ章', 'hasItem': 6, 'examination': true},
    {'number': '64', 'title': 'わら工章', 'hasItem': 3, 'examination': true},
    {'number': '65', 'title': 'アーチェリー章', 'hasItem': 6, 'examination': true},
    {'number': '66', 'title': 'オリエンテーリング章', 'hasItem': 7, 'examination': true},
    {'number': '67', 'title': 'カヌー章', 'hasItem': 7, 'examination': true},
    {'number': '68', 'title': '自転車章', 'hasItem': 4, 'examination': true},
    {'number': '69', 'title': 'スキー章', 'hasItem': 3, 'examination': true},
    {'number': '70', 'title': 'スケート章', 'hasItem': 5, 'examination': true},
    {'number': '71', 'title': '漕艇章', 'hasItem': 8, 'examination': true},
    {'number': '72', 'title': '登山章', 'hasItem': 9, 'examination': true},
    {'number': '73', 'title': '馬事章', 'hasItem': 10, 'examination': true},
    {'number': '74', 'title': 'パワーボート章', 'hasItem': 6, 'examination': true},
    {'number': '75', 'title': 'ヨット章', 'hasItem': 7, 'examination': true},
    {'number': '76', 'title': '武道・武術章', 'hasItem': 2, 'examination': true},
    {'number': '77', 'title': '環境保護章', 'hasItem': 7, 'examination': true},
    {'number': '78', 'title': '報道章', 'hasItem': 8, 'examination': true},
    {'number': '79', 'title': '薬事章', 'hasItem': 8, 'examination': true},
    {'number': '80', 'title': '防災章', 'hasItem': 10, 'examination': true},
    {'number': '81', 'title': '情報処理章', 'hasItem': 8, 'examination': true},
    {'number': '82', 'title': '情報通信章', 'hasItem': 8, 'examination': true},
