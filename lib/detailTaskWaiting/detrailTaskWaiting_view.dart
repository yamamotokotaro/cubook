  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(child: SingleChildScrollView(
          child: Consumer<DetailTaskWaitingModel>(builder: (context, model, _) {
            if (!model.isGet) {
              model.getTaskSnapshot(documentID);
            } else if (model.taskSnapshot.documentID != documentID) {
              model.getTaskSnapshot(documentID);
            }
            if (model.isLoaded) {
...
class DetailTaskWaitingView2 extends StatelessWidget {
  String documentID;
  String name;
  String item;
  String type;
