import 'challengeDetail_model.dart';
...
class ChallengeSignView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
        width: 280,
...
class ChallengeAddView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
