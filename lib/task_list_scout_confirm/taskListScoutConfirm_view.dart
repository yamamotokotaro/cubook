            ...
            child: Column(
              children: <Widget>[
                Padding(
                    ...
                    child: Consumer<TaskListScoutConfirmModel>(builder:
                        (BuildContext context, TaskListScoutConfirmModel model,
                            Widget? child) {
...
=======
                        ...
                        var list_percentage =
                            new List.generate(map_task.length, (index) => 0.0);
