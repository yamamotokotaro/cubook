...
class AccountMigrationView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('アカウントを移行'), systemOverlayStyle: SystemUiOverlayStyle.light,
        ),
                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: TextField(
                                      ...
                                      enabled: true,
                                      decoration:
                                          const InputDecoration(labelText: 'グループID'),
                                      onChanged: (String text) {
                                        //model.joinCode = text;
                                      },
                                    ),
                                  ),
                                  if (model.isLoading) const Padding(
                                          padding: EdgeInsets.all(10),
                                          child: CircularProgressIndicator()) else Padding(
                                          padding: const EdgeInsets.all(10),
                                          child: Container(
                                  ...
                                  Padding(
                                      ...
                                      child: Container(
                                          child: TextButton.icon(
                                            ...
                                            onPressed: () async {
                                              const String url = 'https://sites.google.com/view/cubookinfo/%E4%BD%BF%E3%81%84%E6%96%B9/%E3%82%A2%E3%82%AB%E3%82%A6%E3%83%B3%E3%83%88%E7%A7%BB%E8%A1%8C%E3%81%AE%E6%89%8B%E9%A0%86';
