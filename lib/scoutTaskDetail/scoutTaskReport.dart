...
import 'scoutTaskModel.dart';

class ScoutTaskReport extends StatelessWidget {
  ScoutTaskReport(int? _index, String? _type, String _mes) {
  ...
  Widget build(BuildContext context) {
    return Consumer<ScoutTaskModel>(
        builder: (BuildContext context, ScoutTaskModel model, _) {
