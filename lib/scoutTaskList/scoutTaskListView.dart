...
class ScoutTaskListView extends StatelessWidget {
  ScoutTaskListView(String? _type) {
          ...
          child: Column(
            children: <Widget>[
              Padding(
                  ...
                  child: Consumer<ScoutTaskModel>(builder:
                      (BuildContext context, ScoutTaskModel model,
                          Widget? child) {
                    if (!model.isGet) {
                      model.getSnapshot();
                    }
