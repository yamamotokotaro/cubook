...
class FirebaseAuthUi {
  ...
  static FirebaseAuthUi instance() {
    _instance ??= FirebaseAuthUi._internal();
    return _instance;
  }

  static const MethodChannel _channel = MethodChannel('firebase_auth_ui');
  ...
  Future<FirebaseUser> launchAuth(List<AuthProvider> authProviders,
    ...
    final user = await _channel.invokeMethod('launchFlow', {
  ...
  Future<bool> delete() async {
    final bool result = await _channel.invokeMethod('delete');
    return Future.value(result);
  }
